...
import { Activity, ArrowLeft, Weight, Droplet, Cigarette, Dumbbell, HeartPulse, CalendarClock, Loader2 } from 'lucide-react';
...
function HealthForm() {
  ...
  const factors = [
    ...
    { label: 'Not Physically Active', active: formData.PhysActivity === 0 },
    { label: 'BMI 30+ (Obese range)', active: formData.BMI >= 30 },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_320px] gap-6 items-start">
            <div className="bg-white rounded-2xl shadow-sm border border-vital-ink/5 overflow-hidden">
              <div className="bg-gradient-to-br from-vital-teal to-vital-teal/70 px-7 py-6">
              ...
              <form onSubmit={handleSubmit} className="p-7 space-y-8">
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <YesNoToggle label="Physically Active?" name="PhysActivity" value={formData.PhysActivity} onChange={handleChange} icon={Dumbbell} />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-vital-teal text-white font-body font-medium py-3.5 rounded-xl
                             shadow-lg shadow-vital-teal/25 hover:bg-vital-teal/90 hover:shadow-xl
            ...
            <RiskSummary factors={factors} color="teal" />
          </div>
        </div>
      </div>
    </PageBackground>
